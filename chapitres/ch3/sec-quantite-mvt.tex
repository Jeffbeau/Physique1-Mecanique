...
Un porte-conteneurs de masse $m = \SI{60000}{tonnes}$ navigue à $\SI{14}{n\oe uds}$ ($\approx \SI{7,2}{m/s}$) vers le nord. Un vraquier de masse $m = \SI{80000}{tonnes}$ navigue à $\SI{10}{n\oe uds}$ ($\approx \SI{5,1}{m/s}$) vers l'est.
