...
Un navire de masse $m = \SI{25000}{tonnes} = \SI{25e6}{kg}$ navigue à $v_i = \SI{10}{n\oe uds} \approx \SI{5,14}{m/s}$. Les moteurs sont inversés et exercent une force de freinage constante de $F = \SI{800}{kN}$. Quelle distance le navire parcourt-il avant de s'arrêter?
...
\begin{enumerate}[label=\alph*)]
    ...
    \item Si la glissière fait un angle de $30°$ avec l'horizontale, calculez le travail effectué par la gravité.
