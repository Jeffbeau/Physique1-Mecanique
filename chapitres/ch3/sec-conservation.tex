...
\[ v_B = \sqrt{2gh} = \sqrt{2 \times 9,8 \times 3} = \SI{7,7}{m/s} \approx \SI{15}{n\oe uds} \]
...
Un pendule de longueur $L = \SI{1,5}{m}$ est écarté de $\theta = 30°$ de la verticale, puis lâché. Quelle est sa vitesse au point le plus bas de sa trajectoire?
...
\[ h = 1,5 \times (1 - \cos 30°) = 1,5 \times (1 - 0,866) = 1,5 \times 0,134 = \SI{0,201}{m} \]
...
\reponsepratique{a) $h = v^2/(2g) = \SI{0,459}{m}$ \quad b) $\theta = \arccos(1 - h/L) = \arccos(0,770) \approx 39,6°$}
\end{pratiqueautonome}
...
Une caisse de $m = \SI{50}{kg}$ glisse sur une rampe inclinée à $30°$, parcourant une distance de $d = \SI{4}{m}$ le long de la rampe. Le coefficient de frottement cinétique est $\mu_c = 0,25$. Si la caisse part du repos, quelle est sa vitesse au bas de la rampe?
...
\begin{tikzpicture}[scale=0.7]
    ...
    % Angle
    \draw[thick] (1.5,0) arc (0:30:1.5) node[midway, right] {$30°$};
...
\[ h = d\sin(30°) = 4 \times 0,5 = \SI{2}{m} \]

\textbf{Calcul de la force de frottement :}
\[ N = mg\cos(30°) = 50 \times 9,8 \times 0,866 = \SI{424}{N} \]
