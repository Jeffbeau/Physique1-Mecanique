...
\begin{exemple}{Puissance des moteurs d'un navire}{}
Un cargo de \SI{30000}{tonnes} navigue à vitesse constante de $v = \SI{12}{n\oe uds} \approx \SI{6,2}{m/s}$. La force de résistance totale (eau + air) est estimée à $F_r = \SI{800}{kN}$.
...
\begin{exemple}{Grue de chargement}{}
...
\begin{exemple}{Consommation énergétique d'un navire}{}
