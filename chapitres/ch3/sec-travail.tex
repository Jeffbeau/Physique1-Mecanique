...
\hline
$0^\circ$ & $+1$ & $W = +Fd$ & Force dans le sens du mouvement $\rightarrow$ \textbf{énergie ajoutée} \\
\hline
$90^\circ$ & $0$ & $W = 0$ & Force perpendiculaire $\rightarrow$ \textbf{aucun transfert d'énergie} \\
\hline
$180^\circ$ & $-1$ & $W = -Fd$ & Force opposée au mouvement $\rightarrow$ \textbf{énergie retirée} \\
\hline
\end{tabular}
\end{center}
\end{attention}
...
\subsubsection{Force dans le sens du mouvement ($\theta = 0^\circ$)}

Lorsque la force est appliquée dans la \textbf{même direction} que le déplacement, le travail est \textbf{maximal et positif} :
\[ W = Fd\cos(0^\circ) = Fd \]

\begin{exemple}{Remorqueur poussant un navire}{remorqueur-navire}
...
\subsubsection{Force perpendiculaire au mouvement ($\theta = 90^\circ$)}
...
\subsubsection{Force opposée au mouvement ($\theta = 180^\circ$)}

Lorsque la force est dans la direction \textbf{opposée} au déplacement, le travail est \textbf{négatif} :
\[ W = Fd\cos(180^\circ) = -Fd \]

\begin{exemple}{Freinage d'un navire par inversion des moteurs}{freinage-inversion}
...
\[ W = Fd\cos(180^\circ) = \SI{400e3}{N} \times \SI{500}{m} \times (-1) = -\SI{200}{MJ} \]
...
Un matelot tire une caisse de matériel sur le pont d'un navire. La corde fait un angle de $30^\circ$ avec l'horizontale et exerce une tension de $\SI{250}{N}$. La caisse se déplace horizontalement de $\SI{8}{m}$.
...
\begin{tikzpicture}[scale=0.9]
    ...
    \draw[->] (4.2,0.8) arc (0:30:0.7) node[midway, right] {$30^\circ$};
...
\reponsepratique{$W = Td\cos\theta = 250 \times 8 \times \cos(30^\circ) = 250 \times 8 \times 0,866 \approx \SI{1730}{J}$}
...
\begin{exemple}{Chargement d'un conteneur sur un plan incliné}{conteneur-plan-incline}
Un conteneur de masse $m = \SI{2000}{kg}$ est tiré vers le haut d'une rampe inclinée à $\theta = 20^\circ$ par un câble parallèle à la rampe. Le conteneur monte de $d = \SI{15}{m}$ le long de la rampe. La tension dans le câble est $T = \SI{12000}{N}$ et la force de frottement est $f = \SI{2000}{N}$.
...
\begin{tikzpicture}[scale=0.7]
    ...
    % Angle
    \draw[thick] (2,0) arc (0:20:2) node[midway, right] {$20^\circ$};
...
\textbf{1. Travail de la tension} (parallèle au déplacement, $\theta = 0^\circ$) :
\[ W_T = Td\cos(0^\circ) = \SI{12000}{N} \times \SI{15}{m} \times 1 = +\SI{180000}{J} \]

\textbf{2. Travail du frottement} (opposé au déplacement, $\theta = 180^\circ$) :
\[ W_f = fd\cos(180^\circ) = \SI{2000}{N} \times \SI{15}{m} \times (-1) = -\SI{30000}{J} \]

\textbf{3. Travail de la gravité} (angle de $90^\circ + 20^\circ = 110^\circ$ avec le déplacement) :
\[ W_g = F_g d\cos(110^\circ) = mg \cdot d\cos(110^\circ) \]
\[ W_g = \SI{2000}{kg} \times \SI{9,8}{m/s^2} \times \SI{15}{m} \times \cos(110^\circ) \]
\[ W_g = \SI{294000}{N \cdot m} \times (-0,342) = -\SI{100500}{J} \]

\textbf{4. Travail de la normale} (perpendiculaire au déplacement, $\theta = 90^\circ$) :
\[ W_N = Nd\cos(90^\circ) = 0 \]
...
\begin{exemple}{Conteneur descendu par une grue}{conteneur-grue}
