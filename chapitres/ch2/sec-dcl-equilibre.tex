...
\begin{tikzpicture}[scale=1.0]
    ...
    \begin{scope}[xshift=2.5cm]
        ...
        \node[blue, above right] at (0.4, 1.2) {$\vect{f}$};
    \end{scope}
\end{tikzpicture}
\end{center}
...
Un conteneur de masse $m = \SI{2000}{kg}$ est suspendu dans la cale d'un navire par deux câbles. Le câble de bâbord fait un angle de $\alpha = 30^\circ$ avec l'horizontale, celui de tribord fait un angle de $\beta = 45^\circ$ avec l'horizontale. Déterminer les tensions $T_1$ et $T_2$ dans chaque câble.
...
\begin{tikzpicture}[scale=1.1]
    ...
    % Angle au sommet bas (entre Fg et T1) = 90$^\circ$ - alpha
    \draw[thick] (0, 0.6) arc (90:30:0.6);
    \node at (0.5, 0.8) {\small $90^\circ{-}\alpha$};
    
    % Angle au sommet droit (entre T1 et T2) = 180$^\circ$ - alpha - beta
    \draw[thick] ({3*cos(30) - 0.5*cos(30+60)}, {3*sin(30) + 0.5*sin(30+60)}) arc (120:180-15:0.5);
    
    % Angle au sommet haut (entre T2 et Fg) = 90$^\circ$ - beta
    \draw[thick] (0, 1.9) arc (270:270+45:0.6);
    \node at (0.45, 1.65) {\small $90^\circ{-}\beta$};
    
    % Annotation
    \node[text width=5cm, align=left] at (6.5, 1.25) {
        Les angles du triangle sont :
        \begin{itemize}
            \item En bas : $90^\circ - \alpha$
            \item En haut : $90^\circ - \beta$
...
\[
    \frac{T_1}{\sin(90^\circ - \beta)} = \frac{T_2}{\sin(90^\circ - \alpha)} = \frac{mg}{\sin(\alpha + \beta)}
\]

En utilisant $\sin(90^\circ - \theta) = \cos\theta$ :
\[
...
Avec $m = \SI{2000}{kg}$, $\alpha = 30^\circ$, $\beta = 45^\circ$ :

\[
    \sin(\alpha + \beta) = \sin(75^\circ) = 0{,}966
\]

\[
    T_1 = \frac{mg \cos\beta}{\sin(\alpha + \beta)} = \frac{2000 \times 9{,}81 \times \cos 45^\circ}{\sin 75^\circ} = \frac{19\,620 \times 0{,}707}{0{,}966} = \boxed{\SI{14{,}4}{kN}}
\]

\[
    T_2 = \frac{mg \cos\alpha}{\sin(\alpha + \beta)} = \frac{2000 \times 9{,}81 \times \cos 30^\circ}{\sin 75^\circ} = \frac{19\,620 \times 0{,}866}{0{,}966} = \boxed{\SI{17{,}6}{kN}}
\]

\textbf{Vérification :}
\begin{itemize}
    \item $T_2 > T_1$ : logique car le câble de tribord est plus vertical ($45^\circ > 30^\circ$), il supporte une plus grande partie du poids.
    \item On peut vérifier : $T_1 \sin\alpha + T_2 \sin\beta = 14\,400 \times 0{,}5 + 17\,600 \times 0{,}707 = 7\,200 + 12\,440 \approx mg$ \cmark
\end{itemize}
...
Un feu de navigation de masse $m = \SI{15}{kg}$ est suspendu entre deux mâts par deux câbles. Le câble de bâbord fait un angle de $\alpha = 35^\circ$ avec l'horizontale, celui de tribord fait un angle de $\beta = 50^\circ$ avec l'horizontale.
...
Équation (1) : $-T_1\cos 35^\circ + T_2\cos 50^\circ = 0$

Équation (2) : $T_1\sin 35^\circ + T_2\sin 50^\circ - mg = 0$
...
Un bloc de masse $m = \SI{20}{kg}$ est posé sur un plan incliné à $\theta = 20^\circ$ par rapport à l'horizontale. Le bloc reste immobile. Le coefficient de frottement statique est $\mu_s = 0{,}5$.
...
\[
    f_s = mg\sin\theta = 20 \times 9{,}81 \times \sin 20^\circ = 196{,}2 \times 0{,}342 = \boxed{\SI{67{,}1}{N}}
\]
...
\[
    f_{s,max} = \mu_s N = \mu_s mg\cos\theta = 0{,}5 \times 20 \times 9{,}81 \times \cos 20^\circ = 0{,}5 \times 196{,}2 \times 0{,}940 = \SI{92{,}2}{N}
\]

Comme $f_s = \SI{67{,}1}{N} < f_{s,max} = \SI{92{,}2}{N}$, le bloc reste bien en équilibre. \cmark
...
\]
\[
    \theta_{max} = \arctan(\mu_s) = \arctan(0{,}5) = \boxed{26{,}6^\circ}
\]
...
Une caisse de $\SI{150}{kg}$ est posée sur une rampe de chargement inclinée à $25^\circ$. Le coefficient de frottement statique entre la caisse et la rampe est $\mu_s = 0{,}6$.
...
\textbf{Réponses :}
\begin{enumerate}
    \item $\tan 25^\circ = 0{,}466 < \mu_s = 0{,}6$, donc la caisse \textbf{reste en place}.
    \item $f_s = mg\sin 25^\circ = 150 \times 9{,}81 \times 0{,}423 = \SI{622}{N}$
    \item $\theta_{max} = \arctan(0{,}6) = 31{,}0^\circ$
\end{enumerate}
\end{pratiqueautonome}