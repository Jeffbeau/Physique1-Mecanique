...
\begin{tikzpicture}[scale=0.8]
    ...
    \begin{scope}[xshift=3cm]
        ...
        \node[green!60!black, right] at (0.1, 0.6) {$\vect{F}_A$};
        
        \draw[-{Stealth[length=3mm]}, very thick, purple] (0, 0) -- (2, 0);
        \node[purple, above] at (1, 0.1) {$\vect{F}$};
    \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.8]
    ...
    \begin{scope}[xshift=2.5cm]
        ...
        \draw[-{Stealth[length=3mm]}, very thick, green!60!black] (0, 0) -- (0, 1.2);
        \node[green!60!black, left] at (-0.1, 0.6) {$\vect{N}$};
        
        \draw[-{Stealth[length=3mm]}, very thick, purple] (0, 0) -- (2, 0);
        \node[purple, above] at (1, 0.1) {$\vect{F}$};
        
        \draw[-{Stealth[length=3mm]}, very thick, orange] (0, 0) -- (-1.2, 0);
        \node[orange, above] at (-0.6, 0.1) {$\vect{f}_c$};
    \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.85]
    ...
    \begin{scope}[xshift=2.5cm]
        ...
        \node[blue, above] at (-0.65, 0.1) {$\vect{f}_c$};
    \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{exemple}{Bloc glissant sur un plan incliné}{bloc-glisse}
Un bloc de $m = \SI{10}{kg}$ est lâché du haut d'un plan incliné à $\theta = 35°$. Le coefficient de frottement cinétique est $\mu_c = 0{,}20$. Calculez l'accélération du bloc.
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[font=\scriptsize] at (2.2, 0.7) {(+ vers bas)};
    ...
    % Frottement (vers le haut de la pente)
...
$x$ : parallèle à la pente, positif vers le bas (sens du mouvement)
...
\begin{align*}
    ...
    &= 9{,}81 \times 0{,}410 = \boxed{\SI{4{,}02}{m/s^2}}
\end{align*}

\textbf{Vérification :} Sans frottement, $a = g\sin\theta = 9{,}81 \times 0{,}574 = \SI{5{,}63}{m/s^2}$. Le frottement réduit l'accélération d'environ 29\%.
\end{exemple}
...
Vérification avec le bloc 1 : $F - T = m_1 a$ → $24 - 9 = 5 \times 3 = 15$ ✓
\end{exemple}
...
\begin{itemize}
    ...
    \item $T$ est entre $m_2 g = \SI{29{,}4}{N}$ et $m_1 g = \SI{49{,}1}{N}$ ✓
\end{itemize}
\end{exemple}
...
\begin{tikzpicture}[scale=0.75]
    ...
    % Flèches
    \draw[-{Stealth}, thick, purple] (1.3, 1.2) -- (2.3, 1.78);
    \node[purple, above left] at (1.8, 1.5) {\small $\vec{a}$};
