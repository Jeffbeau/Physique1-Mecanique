...
Un navire navigue \`a $\SI{15}{n\oe{}uds}$ avec un cap de $30^\circ$ par rapport \`a l'est (c'est-\`a-dire $30^\circ$ nord de l'est).
...
\[ v_x = v \cos\theta = 15 \cos 30^\circ = 15 \times 0,866 = \SI{13,0}{n\oe{}uds} \]

\textbf{Composante nord-sud :}
\[ v_y = v \sin\theta = 15 \sin 30^\circ = 15 \times 0,5 = \SI{7,5}{n\oe{}uds} \]
