...
\begin{exemple}{Cap et vitesse d'un navire}{cap-vitesse-navire}
Un navire navigue \`a $\SI{15}{\knots}$ avec un cap de $30^\circ$ par rapport \`a l'est (c'est-\`a-dire $30^\circ$ nord de l'est).
...
% Vecteur vitesse
\draw[very thick, blue, ->] (0,0) -- (2.6,1.5) node[above right] {$\vec{v} = \SI{15}{\knots}$};
% Composantes
...
\[ v_x = v \cos\theta = 15 \cos 30^\circ = 15 \times 0,866 = \SI{13,0}{\knots} \]

\textbf{Composante nord-sud :}
\[ v_y = v \sin\theta = 15 \sin 30^\circ = 15 \times 0,5 = \SI{7,5}{\knots} \]

Le navire se d\'eplace donc \`a $\SI{13,0}{\knots}$ vers l'est et $\SI{7,5}{\knots}$ vers le nord.
\end{exemple}
