...
\begin{itemize}
    ...
    \item Un navire peut afficher $\SI{10}{n\oe{}uds}$ au loch mais n'avancer que de $\SI{7}{n\oe{}uds}$ par rapport au fond s'il navigue contre un courant de $\SI{3}{n\oe{}uds}$.
\end{itemize}
\end{remarque}

\begin{exemple}{Effet du courant sur la navigation}{}
Un cargo affiche $\SI{12}{n\oe{}uds}$ au loch (vitesse surface). Il navigue dans le fleuve Saint-Laurent où le courant est de $\SI{2}{n\oe{}uds}$.

\textbf{Cas 1 : Courant favorable (même sens que le navire)}
\[ v_{fond} = 12 + 2 = \SI{14}{n\oe{}uds} \]

\textbf{Cas 2 : Courant contraire (sens opposé)}
\[ v_{fond} = 12 - 2 = \SI{10}{n\oe{}uds} \]
