...
Un marin tombe d'un navire qui avance à $\SI{8}{\knots}$. Il tombe d'une hauteur de $\SI{10}{m}$. À quelle distance horizontale du point de chute le marin entre-t-il dans l'eau?
...
\[ v_{0x} = \SI{8}{\knots} \times \frac{\SI{0,5144}{m/s}}{\SI{1}{\knots}} = \SI{4,1}{m/s} \]
