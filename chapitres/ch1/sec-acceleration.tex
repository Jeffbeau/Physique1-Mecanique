...
Un navire se déplace vers l'ouest (sens négatif de l'axe) à $\SI{12}{n\oe{}uds}$. Déterminez le signe de l'accélération dans chaque cas :
...
Un vraquier quitte le port de Montr\'eal. Sa vitesse passe de $\SI{0}{n\oe{}ud}$ \`a $\SI{10}{n\oe{}uds}$ en $\SI{15}{minutes}$.

\textbf{Conversion en unit\'es SI :}
\begin{align*}
v_i &= \SI{0}{m/s} \\[0.2cm]
v_f &= \SI{10}{n\oe{}uds} \times \frac{\SI{0,5144}{m/s}}{\SI{1}{n\oe{}ud}} = \SI{5,14}{m/s} \\[0.2cm]
...
Un p\'etrolier naviguant \`a $\SI{15}{n\oe{}uds}$ (vers l'est, donc $v_i > 0$) doit s'arr\^eter. En raison de sa grande inertie, le freinage prend $\SI{20}{minutes}$.

\textbf{Conversion en unit\'es SI :}
\begin{align*}
v_i &= \SI{15}{n\oe{}uds} \times \frac{\SI{0,5144}{m/s}}{\SI{1}{n\oe{}ud}} = \SI{+7,72}{m/s} \\[0.2cm]
v_f &= \SI{0}{m/s} \\[0.2cm]
...
\begin{pratiqueautonome}
Un vraquier naviguant à $\SI{8}{n\oe{}uds}$ vers l'est doit s'arrêter. Son accélération de freinage est de $a = \SI{-0,004}{m/s^2}$.
