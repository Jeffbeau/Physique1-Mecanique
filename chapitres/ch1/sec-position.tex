...
Un vraquier de $\SI{200}{m}$ de long navigue en haute mer à $\SI{12}{\knots}$. Pour calculer son temps de traversée sur une distance de $\SI{500}{milles nautiques}$, on peut traiter le navire comme une particule : ses dimensions ($\SI{200}{m}$) sont négligeables par rapport à la distance parcourue ($\SI{926}{km}$).
