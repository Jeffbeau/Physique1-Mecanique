...
\hline
$360^\circ$ & $2\pi$ rad & 1 tour \\
\hline
$180^\circ$ & $\pi$ rad & $\frac{1}{2}$ tour \\
\hline
$90^\circ$ & $\frac{\pi}{2}$ rad & $\frac{1}{4}$ tour \\
\hline
$60^\circ$ & $\frac{\pi}{3}$ rad & $\frac{1}{6}$ tour \\
\hline
$45^\circ$ & $\frac{\pi}{4}$ rad & $\frac{1}{8}$ tour \\
\hline
$1^\circ$ & $\frac{\pi}{180}$ rad $\approx 0,0175$ rad & -- \\
\hline
$57,3^\circ$ & $1$ rad & -- \\
\hline
\end{tabular}
...
\begin{exemple}{Câble enroulé sur un treuil}{cable-treuil}
...
\begin{itemize}
    ...
    \item \textbf{Degrés par seconde} ($^\circ$/s)
\end{itemize}
...
\begin{exemple}{Vitesse en bout de pale d'hélice}{vitesse-pale-helice}
...
\begin{exemple}{Démarrage d'un treuil}{demarrage-treuil}
...
\begin{exemple}{Freinage d'une hélice}{freinage-helice}
...
\begin{exemple}{Radar rotatif}{radar-rotatif}
...
\begin{exemple}{Cabestan (exemple de calcul complet)}{cabestan-complet}
