...
\begin{exemple}{Passage entre notation scientifique et préfixes SI}{notation-prefixes}
...
\begin{exemple}{Conversion de milles marins en kilomètres}{conv-nm-km}
...
\begin{exemple}{Conversion km/h en m/s}{conv-kmh-ms}
...
\begin{exemple}{Conversion de nœuds en km/h}{conv-kn-kmh}
...
\begin{exemple}{Conversion de psi en kilopascals}{conv-psi-kpa}
...
\begin{exemple}{Conversion de cm² en m²}{conv-cm2-m2}
...
\begin{exemple}{Conversion de pieds cubes en m³}{conv-pi3-m3}
...
\begin{exemple}{Vérification d'homogénéité -- énergie cinétique}{homogeneite-ec}
...
\begin{exemple}{Détection d'une formule non homogène}{formule-non-homogene}
