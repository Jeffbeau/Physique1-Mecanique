...
\end{tikzpicture}
\caption{Un vecteur $\vect{A}$ dans le plan cartésien. Module : $\|\vect{A}\| = 7{,}81$, orientation : $\theta = 50{,}2°$}
\label{fig:vecteur-A}
\end{figure}
...
\begin{tikzpicture}[scale=0.6]
    ...
    \begin{scope}[xshift=0cm]
        ...
        \node[blue, font=\footnotesize] at (1.0,0.3) {$45°$};
        \node[below, font=\footnotesize, align=center] at (1.2,-1.2) {Vent\\ $30 \angle 45°$ km/h};
    \end{scope}
    ...
    \begin{scope}[xshift=7cm]
        ...
        \node[below, font=\footnotesize, align=center] at (-1,-1.2) {Déplacement\\ $5 \angle 180°$ m};
    \end{scope}
    % Exemple 3 : Force
    \begin{scope}[xshift=13cm]
        ...
        \node[green!60!black, font=\footnotesize] at (1.0,-0.25) {$-30°$};
        \node[below, font=\footnotesize, align=center] at (1.2,-2.8) {Force\\ $100 \angle -30°$ N};
    \end{scope}
\end{tikzpicture}
...
Sur la Figure~\ref{fig:vecteur-A}, le vecteur $\vect{A}$ a un module de 7,81 et une orientation de 50,2°. On écrit alors : $\vect{A} = 7{,}81 \angle 50{,}2°$
...
\begin{align*}
    ...
    \alpha &= \arctan\left(\frac{|A_y|}{|A_x|}\right) \quad \text{(angle de référence, entre 0° et 90°)}
\end{align*}
On interprète ensuite la position de l'angle selon les signes des composantes :
\begin{itemize}
    \item Q1 : $\theta = \alpha$
    \item Q2 : $\theta = 180° - \alpha$
    \item Q3 : $\theta = 180° + \alpha$
    \item Q4 : $\theta = -\alpha$ \quad (ou $360° - \alpha$)
\end{itemize}
\end{equationimportante}

\begin{attention}
En utilisant les \textbf{valeurs absolues} des composantes, l'angle de référence $\alpha$ est toujours entre $0°$ et $90°$. Il suffit ensuite de regarder les signes de $A_x$ et $A_y$ pour déterminer le quadrant et calculer $\theta$.
\end{attention}
...
\begin{tikzpicture}[scale=1.1]
    ...
    \node[blue, font=\footnotesize] at (1.0,0.3) {$37°$};
    \node[align=left, font=\footnotesize] at (3.0,2.0) {Q1 : $\theta = 37°$};
    
    % Quadrant II
    \draw[vecteur rouge, line width=1.2pt] (0,0) -- (-2,1.5);
    \draw[thick, red] (-0.6,0) arc (180:143:0.6);
    \node[red, font=\footnotesize] at (-1.0,0.3) {$37°$};
    \node[align=right, font=\footnotesize] at (-3.0,2.0) {Q2 : $\theta = 180° - 37°$};
    \node[align=right, font=\footnotesize] at (-3.0,1.4) {$= 143°$};
    
    % Quadrant III
    \draw[vecteur vert, line width=1.2pt] (0,0) -- (-2,-1.5);
    \draw[thick, green!60!black] (-0.6,0) arc (180:217:0.6);
    \node[green!60!black, font=\footnotesize] at (-1.0,-0.35) {$37°$};
    \node[align=right, font=\footnotesize] at (-3.0,-1.4) {Q3 : $\theta = 180° + 37°$};
    \node[align=right, font=\footnotesize] at (-3.0,-2.0) {$= 217°$};
    
    % Quadrant IV
    \draw[vecteur orange, line width=1.2pt] (0,0) -- (2,-1.5);
    \draw[thick, orange] (0.6,0) arc (0:-37:0.6);
    \node[orange, font=\footnotesize] at (1.0,-0.4) {$37°$};
    \node[align=left, font=\footnotesize] at (3.0,-1.4) {Q4 : $\theta = -37°$};
    \node[align=left, font=\footnotesize] at (3.0,-2.0) {ou $360° - 37° = 323°$};
...
\begin{align*}
    ...
    \theta &= \arctan\left(\frac{6}{5}\right) = \arctan(1{,}2) \approx 50{,}2°
\end{align*}
On peut donc écrire : $\vect{A} = 7{,}81 \angle 50{,}2°$
\end{minipage}
\hfill
...
\begin{align*}
    ...
    \alpha &= \arctan\left(\frac{|3|}{|-4|}\right) = \arctan(0{,}75) = 36{,}9°
\end{align*}
Le vecteur est en \textbf{Q2} car $B_x < 0$ et $B_y > 0$.

Donc : $\theta = 180° - 36{,}9° = 143°$
\end{minipage}
\hfill
\begin{minipage}{0.4\textwidth}
\centering
...
\begin{itemize}
    \item $\vect{A} = 5{,}0 \angle 60°$ (Q1)
    \item $\vect{B} = 4{,}0 \angle 135°$ (Q2)
    \item $\vect{C} = 6{,}0 \angle 210°$ (Q3)
    \item $\vect{D} = 3{,}0 \angle -45°$ (Q4)
\end{itemize}
...
\textbf{Q1 :} $\vect{A} = 5{,}0 \angle 60°$ & $A_x = 5{,}0\cos(60°) = 2{,}50$ ; $A_y = 5{,}0\sin(60°) = 4{,}33$ & $\vect{A} = (2{,}50,\; 4{,}33)$ \\[0.3em]
\textbf{Q2 :} $\vect{B} = 4{,}0 \angle 135°$ & $B_x = 4{,}0\cos(135°) = -2{,}83$ ; $B_y = 4{,}0\sin(135°) = 2{,}83$ & $\vect{B} = (-2{,}83,\; 2{,}83)$ \\[0.3em]
\textbf{Q3 :} $\vect{C} = 6{,}0 \angle 210°$ & $C_x = 6{,}0\cos(210°) = -5{,}20$ ; $C_y = 6{,}0\sin(210°) = -3{,}00$ & $\vect{C} = (-5{,}20,\; -3{,}00)$ \\[0.3em]
\textbf{Q4 :} $\vect{D} = 3{,}0 \angle -45°$ & $D_x = 3{,}0\cos(-45°) = 2{,}12$ ; $D_y = 3{,}0\sin(-45°) = -2{,}12$ & $\vect{D} = (2{,}12,\; -2{,}12)$
\end{tabular}
}
\end{exemple}
...
Décomposer le vecteur force $\vect{F} = 120 \angle 55°$ N en ses composantes $F_x$ et $F_y$.
...
\begin{pratiqueautonome}
Décomposer le vecteur vitesse $\vect{v} = 8{,}5 \angle 210°$ m/s en ses composantes.
...
\reponsepratique{$\|\vect{C}\| = \SI{3,0}{kn}$, $\theta = 143°$}
\end{pratiqueautonome}
...
\textbf{Contre-exemple :} Soit $\vect{A} = 5{,}0 \angle 30°$ et $\vect{B} = 3{,}0 \angle 110°$.
...
\]
L'orientation : $\theta = \arctan(4/3) = 53{,}1°$ nord de l'est.
\end{exemple}
...
\begin{exemple}
\textbf{Méthode géométrique avec la loi des cosinus}

Additionner les vecteurs $\vect{A} = 5{,}0 \angle 30°$ et $\vect{B} = 3{,}0 \angle 110°$ en utilisant la méthode géométrique.
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node[orange] at (5.0,3.4) {\small $80°$};
    % Résultante
...
L'angle entre $\vect{A}$ et $\vect{B}$ est : $110° - 30° = 80°$
...
\]
\[
    \|\vect{R}\|^2 = 5{,}0^2 + 3{,}0^2 - 2(5{,}0)(3{,}0)\cos(100°)
\]
\[
...
\[
    \frac{\sin\alpha}{\|\vect{B}\|} = \frac{\sin C}{\|\vect{R}\|} \quad \Rightarrow \quad \sin\alpha = \frac{\|\vect{B}\|\sin C}{\|\vect{R}\|} = \frac{3{,}0 \times \sin(100°)}{6{,}26} = 0{,}472
\]
\[
    \alpha = \arcsin(0{,}472) = 28{,}2°
\]
...
\textbf{Réponse :} $\vect{R} = 6{,}26 \angle 58{,}2°$
\end{exemple}
...
Orientation : $\theta = \arctan(6/2) \approx 71{,}6°$
\end{minipage}
\hfill
...
\begin{exemple}
\textbf{Méthode des composantes pour le même problème}

Reprenons les vecteurs $\vect{A} = 5{,}0 \angle 30°$ et $\vect{B} = 3{,}0 \angle 110°$ et résolvons avec la méthode des composantes.

\textbf{Étape 1 :} Décomposer en composantes
\begin{align*}
    \vect{A} &: \quad A_x = 5{,}0\cos(30°) = 4{,}33 \quad A_y = 5{,}0\sin(30°) = 2{,}50 \\
    \vect{B} &: \quad B_x = 3{,}0\cos(110°) = -1{,}03 \quad B_y = 3{,}0\sin(110°) = 2{,}82
\end{align*}
...
\begin{align*}
    ...
    \theta &= \arctan\left(\frac{5{,}32}{3{,}30}\right) = 58{,}2°
\end{align*}

\textbf{Réponse :} $\vect{R} = 6{,}26 \angle 58{,}2°$ ou $\vect{R} = (3{,}30,\; 5{,}32)$
...
Orientation : $\theta = \arctan(-4/3) = -53{,}1°$ (Q4)
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
\centering
...
\begin{pratiqueautonome}
Un remorqueur exerce une force $\vect{F}_1 = 25 \angle 40°$ kN sur un navire. Un second remorqueur exerce une force $\vect{F}_2 = 18 \angle 140°$ kN.
...
\reponsepratique{$\vect{R} = 29{,}5 \angle 81{,}4°$ kN \quad (ou $\vect{R} = (4{,}41,\; 29{,}2)$ kN)}
\end{pratiqueautonome}

\begin{pratiqueautonome}
Un navire navigue à une vitesse $\vect{v}_{\text{navire}} = 12 \angle 60°$ nœuds par rapport à l'eau. Le courant marin est $\vect{v}_{\text{courant}} = 3{,}0 \angle 180°$ nœuds (vers l'ouest).

Quelle est la vitesse résultante $\vect{v}_{\text{fond}}$ du navire par rapport au fond marin?

\espaceresolution[8cm]

\reponsepratique{$\vect{v}_{\text{fond}} = 11{,}4 \angle 66{,}2°$ kn \quad (ou $\vect{v}_{\text{fond}} = (3{,}00,\; 10{,}4)$ kn)}
\end{pratiqueautonome}
...
\begin{itemize}
    ...
    \item $\vect{F}_2 = 100 \angle 120°$ N \quad (force du courant)
    \item $\vect{F}_3 = 80 \angle 240°$ N \quad (force du vent)
\end{itemize}
...
\reponsepratique{$\vect{R} = 64{,}0 \angle 40{,}9°$ N \quad (ou $\vect{R} = (48{,}4,\; 41{,}9)$ N)}
\end{pratiqueautonome}
