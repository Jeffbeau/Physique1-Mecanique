...
\begin{enumerate}[label=\alph*)]
    ...
    \item Le conteneur a des dimensions $\SI{6}{m} \times \SI{2,4}{m}$ (longueur $\times$ largeur). En supposant qu'il ne tourne pas pendant la chute, quelle est la  zone de danger au sol (rectangle où le conteneur pourrait tomber)?
\end{enumerate}
