...
Un marin tombe d'un navire qui se déplace à $\SI{14}{n\oe{}uds}$. L'équipage met $\SI{45}{s}$ avant de réagir (temps de réaction), puis le navire freine avec une décélération de $\SI{0,15}{m/s^2}$ jusqu'à l'arrêt.
...
\textbf{27.} a) $x_A = 4{,}12t$ ; $x_B = 3000 - 0{,}005t^2$ \quad b) $\SI{466}{s} \approx \SI{7,8}{min}$ \quad c) $\SI{1920}{m}$ de A \quad d) $\SI{4,7}{m/s} \approx \SI{9,1}{n\oe{}uds}$
...
\textbf{S3.} a) $\SI{71,4}{m}$ \quad b) $v = \SI{37,5}{m/s}$ à $48,2°$ sous l'horizontale \quad c) Réduit de $\SI{5,7}{m}$ (larguer à $\SI{65,7}{m}$) \quad d) $\SI{59,8}{m}$
