...
\begin{enumerate}[label=\alph*)]
    ...
    \item La tension d'un câble de remorquage qui fait un angle de $20°$ avec la direction du mouvement du navire remorqué.
\end{enumerate}


% ---- EXERCICE 3 ----
\item[$\star\star$] \textbf{3.} Un matelot tire une caisse de matériel ($m = \SI{40}{kg}$) sur le pont d'un navire à l'aide d'une corde qui fait un angle de $\theta = 30°$ avec l'horizontale. La tension dans la corde est $T = \SI{200}{N}$. La caisse se déplace horizontalement sur une distance de $d = \SI{12}{m}$. Le coefficient de frottement cinétique entre la caisse et le pont est $\mu_c = 0{,}20$.
...
% ---- EXERCICE 4 ----
\item[$\star\star$] \textbf{4.} Un conteneur de masse $m = \SI{500}{kg}$ est tiré vers le haut d'une rampe inclinée à $\theta = 25°$ par un câble parallèle à la rampe exercant une tension $T = \SI{4000}{N}$. Le conteneur parcourt une distance $d = \SI{8}{m}$ le long de la rampe. Le coefficient de frottement cinétique est $\mu_c = 0{,}15$.
...
% ---- EXERCICE 5 ----
\item[$\star\star$] \textbf{5.} Un cargo de masse $m = \SI{20000}{tonnes}$ navigue à $v_i = \SI{10}{n\oe uds}$ ($\approx \SI{5{,}14}{m/s}$). Le capitaine ordonne l'inversion des moteurs, qui exercent une force de freinage constante de $F = \SI{400}{kN}$.
...
% ---- EXERCICE 8 ----
\item[$\star\star$] \textbf{8.} Un canot de sauvetage de masse $m = \SI{350}{kg}$ est lancé le long d'une glissière inclinée à $30°$ par rapport à l'horizontale. La glissière mesure $L = \SI{10}{m}$ de long. Le canot part du repos. En négligeant le frottement :
...
% ---- EXERCICE 10 ----
\item[$\star\star\star$] \textbf{10.} Une caisse de matériel de masse $m = \SI{100}{kg}$ glisse du repos le long d'une rampe de chargement inclinée à $\theta = 30°$, sur une distance de $d = \SI{6}{m}$ le long de la rampe. Le coefficient de frottement cinétique est $\mu_c = 0{,}20$.
...
% ---- EXERCICE 12 ----
\item[$\star\star$] \textbf{12.} Un cargo de \SI{25000}{tonnes} navigue à vitesse constante de $v = \SI{14}{n\oe uds}$ ($\approx \SI{7{,}20}{m/s}$). La résistance totale (eau + air) est estimée à $F_r = \SI{650}{kN}$.
...
\begin{enumerate}[label=\alph*)]
    ...
    \item Si le navire réduit sa vitesse à $\SI{10}{n\oe uds}$ ($\approx \SI{5{,}14}{m/s}$) et que la résistance diminue à $\SI{350}{kN}$, quelle est la nouvelle puissance requise? Comparez avec la réponse en a).
\end{enumerate}
...
\begin{itemize}
    \item Cargo : $m_1 = \SI{15000}{tonnes}$, $v_1 = \SI{5}{m/s}$, cap $090°$ (vers l'est)
    \item Traversier : $m_2 = \SI{5000}{tonnes}$, $v_2 = \SI{8}{m/s}$, cap $000°$ (vers le nord)
\end{itemize}
...
Un cargo ($m_1 = \SI{15000}{tonnes}$, cap $090°$, vitesse $\SI{5}{m/s}$) et un traversier ($m_2 = \SI{5000}{tonnes}$, cap $000°$, vitesse $\SI{8}{m/s}$) entrent en collision. Les navires restent enchevêtrés (collision parfaitement inélastique).
...
\textbf{2.} a) Positif ($\theta = 0°$). \quad b) Négatif ($\theta = 180°$). \quad c) Nul ($\theta = 90°$). \quad d) Négatif (force vers le bas, déplacement vers le haut, $\theta = 180°$). \quad e) Positif ($\cos 20° > 0$).

\textbf{3.} a) $W_T = Td\cos\theta = 200 \times 12 \times \cos 30° = 200 \times 12 \times 0{,}866 \approx \SI{2078}{J}$
...
\textbf{4.} a) $W_T = Td = 4000 \times 8 = \SI{32\,000}{J}$
    ...
    b) $\Delta y = d\sin 25° = 8 \times 0{,}4226 = \SI{3{,}38}{m}$; \quad $W_g = -mg\Delta y = -500 \times 9{,}8 \times 3{,}38 = \SI{-16\,562}{J}$
    
    c) $N = mg\cos 25° = 500 \times 9{,}8 \times 0{,}9063 = \SI{4441}{N}$; \quad $f = 0{,}15 \times 4441 = \SI{666}{N}$; \quad $W_f = -666 \times 8 = \SI{-5330}{J}$
...
\textbf{8.} a) $h = L\sin 30° = 10 \times 0{,}5 = \SI{5}{m}$
    
    b) $v = \sqrt{2gh} = \sqrt{2 \times 9{,}8 \times 5} = \sqrt{98} = \SI{9{,}9}{m/s}$
    
    c) $\frac{1}{2}mv^2 = mg L\sin 30° \Rightarrow L = \dfrac{v^2}{2g\sin 30°} = \dfrac{144}{2 \times 9{,}8 \times 0{,}5} = \SI{14{,}7}{m}$
...
\textbf{10.} a) $h = d\sin 30° = 6 \times 0{,}5 = \SI{3}{m}$
    
    b) $N = mg\cos 30° = 100 \times 9{,}8 \times 0{,}866 = \SI{849}{N}$; \quad $f = 0{,}20 \times 849 = \SI{170}{N}$; \quad $W_f = -170 \times 6 = \SI{-1020}{J}$
...
\textbf{22.} Axe $x$ vers l'est, axe $y$ vers le nord.
    ...
    c) $v_f = \sqrt{3{,}75^2 + 2{,}0^2} = \sqrt{18{,}06} = \SI{4{,}25}{m/s}$; \quad $\theta = \arctan(2{,}0 / 3{,}75) = 28{,}1°$ nord de l'est; \quad Cap $\approx 062°$
...
\textbf{25.} a) $v_{fx} = \dfrac{15 \times 10^6 \times 5}{20 \times 10^6} = \SI{3{,}75}{m/s}$; \quad $v_{fy} = \dfrac{5 \times 10^6 \times 8}{20 \times 10^6} = \SI{2{,}0}{m/s}$
    ...
    $v_f = \sqrt{3{,}75^2 + 2{,}0^2} = \SI{4{,}25}{m/s} \approx \SI{8{,}3}{n\oe uds}$; \quad Cap $\approx 062°$
