...
\begin{exemple}
Un pétrolier chargé de 200\,000 tonnes de pétrole possède une inertie colossale. Même avec des moteurs extrêmement puissants, il lui faut plusieurs kilomètres pour passer de sa vitesse de croisière à l'arrêt complet. Ce n'est pas que les moteurs sont faibles — c'est que la masse à ralentir est énorme. Cette réalité impose aux officiers de marine d'anticiper leurs manœuvres très longtemps à l'avance.
\end{exemple}

\begin{remarque}[title=Pour aller plus loin : d'où vient la masse?]
À l'échelle subatomique, la masse a une origine surprenante. Les protons et neutrons qui constituent les noyaux atomiques sont eux-mêmes composés de quarks, liés entre eux par des gluons. Or, la masse des quarks ne représente qu'environ 1\% de la masse d'un proton! Les 99\% restants proviennent de l'énergie de liaison entre les quarks, selon la célèbre équation d'Einstein $E = mc^2$. Autrement dit, la majeure partie de votre masse provient non pas de « matière » au sens classique, mais d'énergie confinée.
\end{remarque}
