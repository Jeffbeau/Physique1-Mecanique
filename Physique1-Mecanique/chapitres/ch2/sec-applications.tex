...
\begin{tikzpicture}[scale=1.0]
    ...
    \begin{scope}[xshift=-4.5cm]
        ...
        % Skieur (bonhomme simplifié)
        \begin{scope}[rotate=20, shift={(1.8,0.1)}]
            % Corps
            \draw[thick, fill=red!30] (0,0.3) circle (0.25);
            \draw[thick] (0,0) -- (0,-0.5);
            \draw[thick] (0,-0.2) -- (-0.3,-0.1);
            \draw[thick] (0,-0.2) -- (0.3,-0.1);
            \draw[thick] (0,-0.5) -- (-0.2,-0.9);
            \draw[thick] (0,-0.5) -- (0.2,-0.9);
            % Skis
            \draw[very thick, blue] (-0.4,-0.9) -- (0.6,-0.9);
        \end{scope}
        ...
        % Flèche mouvement
        \draw[->, very thick, purple] (3.2,1.3) -- (4.2,0.93) node[right] {\small mouvement};
