...
\begin{exemple}{Travers\'ee avec courant lat\'eral --- Décomposition vectorielle}{}
...
\[ \sin\theta = \frac{v_{courant}}{v_{surface}} = \frac{3}{10} = 0{,}3 \quad \Rightarrow \quad \boxed{\theta = 17{,}5° \text{ ouest du nord}} \]

\textbf{Vitesse fond r\'esultante} (composante $y$) :
\[ v_{fond} = v_{fond,y} = v_{surface}\cos\theta = 10 \times \cos(17{,}5°) = \boxed{\SI{9{,}5}{n\oe{}uds}} \]
